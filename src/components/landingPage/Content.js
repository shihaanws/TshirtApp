            ...
            <div className="container content">
                <div className="row">
                    <div className="col-sm-3 talk">
                        ...
                        <br />
                        <h6><a onClick={e => history.push('/dashboard')} className="btn btn-primary btn-lg " href="#" >Start Designing</a></h6>
                    </div>
                    <div className="col-sm-7 img-responsive showcase-img">
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                                ...
                                <h5>Collection</h5>
                                <p class="lead mb-0">Save and review your design collection under TshirtDesigns.</p>
                            </div>
                        </div>
                        <div class="col-lg-4">
